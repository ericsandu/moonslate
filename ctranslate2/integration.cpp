...
int main(int argc, char* argv[]) {
    ...
    // Combine all transcribed lines into one continuous string
    std::string transcribed_text = "";
    for (const auto& line : transcript.lines) {
        transcribed_text += line.text + " ";
    }
    
    std::cout << " -> Moonshine Heard: " << transcribed_text << "\n\n";


    // ==========================================
    // 2. Machine Translation (CTranslate2)
    // ==========================================
    std::cout << "[2] Running Machine Translation via CTranslate2..." << std::endl;
    ...
    // Tokenize the exact text generated by Moonshine
    std::vector<std::string> tokens;
    source_spm.Encode(transcribed_text, &tokens);
    ...
    std::cout << " -> Translated Text: " << output_text << std::endl;
